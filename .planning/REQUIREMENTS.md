...
- [x] **VIDEO-03**: A `yuvj420p` → `yuv420p` + full-range change produces exactly **one** finding, on `video.color.range`, because pix_fmt range-folding runs before comparison
